...
class CastingAgencyTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.database_path = os.environ.get('DATABASE_URL', 'postgresql://postgres:abc123@localhost:5432/casting_agency_redux')
    ...
    def test_create_actor_unauthorized(self):
        ...
        data = json.loads(res.data)
        print(res.data)  # Add this line to print the response data for debugging
    ...
    def test_create_actor_unauthorized(self):
        res = self.client().post('/actors', json=self.new_actor)
        data = json.loads(res.data)
        print('Status Code:', res.status_code)  # Print the status code
        print('Response Data:', res.data)       # Print the response data
        self.assertEqual(res.status_code, 401)
